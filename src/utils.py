...
def get_all_activities(start_date: date | None, end_date: date | None) -> dict:
    ...
    activities = client.get_activities(
        before=datetime(end_date.year, end_date.month, end_date.day) if end_date else None, 
        after=datetime(start_date.year, start_date.month, start_date.day) if start_date else None
    )
